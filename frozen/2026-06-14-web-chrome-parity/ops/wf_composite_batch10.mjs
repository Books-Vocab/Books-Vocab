...
const BATCH = [
  { surface: 'Account Section · Auth Summary', dir: 'account-auth-summary', scenarios: ['Initials · Free', 'Initials · Pro', 'Long Name + Email Overflow'] },
  { surface: 'Login Sheet', dir: 'login-sheet', scenarios: ['Authenticating', 'Default', 'Error'] },
  { surface: 'Welcome', dir: 'welcome', scenarios: ['Step 1 / Capture', 'Step 2 / Link', 'Step 3 / Dark', 'Step 3 / Review'] },
]
