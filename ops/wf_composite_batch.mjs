...
const BATCH = [
  { surface: 'Banners · Review', dir: 'banner-review', scenarios: ['Both types (mixed)', 'Due only', 'Large counts (stress)', 'Unlearned only'] },
  { surface: 'Collocation Explain', dir: 'collocation-explain', scenarios: ['Loaded · short', 'Loaded · long', 'Loaded · with delete'] },
  { surface: 'KG Empty State', dir: 'kg-empty-state', scenarios: ['Multi filter', 'No entries (logged out)', 'No entries (with CTA)', 'Search no match', 'Single filter (due)'] },
]
