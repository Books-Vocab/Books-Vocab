...
private extension DemoDataProvider {
    ...
    static let specs: [EntrySpec] = [
        ...
        EntrySpec(
            ...
            links: [
                "confusable": [
                    KGCardLinkSummary(id: "l-ae-1", cardId: ids["effect"]!, word: "effect", kind: "confusable", label: "易混淆", confidence: 0.95, reason: "affect (v.) vs effect (n.) — 拼寫相近但詞性不同")
                ]
            ]
        ),
        EntrySpec(
            ...
            links: [
                "confusable": [
                    KGCardLinkSummary(id: "l-ea-1", cardId: ids["affect"]!, word: "affect", kind: "confusable", label: "易混淆", confidence: 0.95, reason: "effect (n.) vs affect (v.) — 拼寫相近但詞性不同")
                ]
            ]
        ),

        // ── Confused pair: complement / compliment ──
        EntrySpec(
            word: "complement",
            ...
            links: [
                "confusable": [
                    KGCardLinkSummary(id: "l-cc-1", cardId: ids["compliment"]!, word: "compliment", kind: "confusable", label: "易混淆", confidence: 0.92, reason: "complement（補充）vs compliment（讚美）— 一字之差")
                ]
            ]
        ),
        EntrySpec(
            word: "compliment",
            cardId: ids["compliment"]!,
            translation: "讚美；恭維",
            ...
            links: [
                "confusable": [
                    KGCardLinkSummary(id: "l-cc-2", cardId: ids["complement"]!, word: "complement", kind: "confusable", label: "易混淆", confidence: 0.92, reason: "compliment（讚美）vs complement（補充）— 一字之差")
                ]
            ]
        ),

        // ── Confused pair: imply / infer ──
        EntrySpec(
            word: "imply",
            cardId: ids["imply"]!,
            translation: "暗示；意味著",
            ...
            links: [
                "confusable": [
                    KGCardLinkSummary(id: "l-ii-1", cardId: ids["infer"]!, word: "infer", kind: "confusable", label: "易混淆", confidence: 0.90, reason: "imply（說者暗示）vs infer（聽者推斷）— 方向相反")
                ]
            ]
        ),
        EntrySpec(
            ...
            links: [
                "confusable": [
                    KGCardLinkSummary(id: "l-ii-2", cardId: ids["imply"]!, word: "imply", kind: "confusable", label: "易混淆", confidence: 0.90, reason: "infer（聽者推斷）vs imply（說者暗示）— 方向相反")
                ]
            ]
        ),

        // ── Confused pair: elicit / illicit ──
        EntrySpec(
            word: "elicit",
            cardId: ids["elicit"]!,
            translation: "引出；引起",
            ...
            links: [
                "confusable": [
                    KGCardLinkSummary(id: "l-ei-1", cardId: ids["illicit"]!, word: "illicit", kind: "confusable", label: "易混淆", confidence: 0.88, reason: "elicit（引出，動詞）vs illicit（非法的，形容詞）")
                ]
            ]
        ),
        EntrySpec(
            ...
            links: [
                "confusable": [
                    KGCardLinkSummary(id: "l-ei-2", cardId: ids["elicit"]!, word: "elicit", kind: "confusable", label: "易混淆", confidence: 0.88, reason: "illicit（非法的，形容詞）vs elicit（引出，動詞）")
                ]
            ]
        ),

        // ── Confused pair: precede / proceed ──
        EntrySpec(
            word: "precede",
            cardId: ids["precede"]!,
            translation: "在⋯之前；先於",
            ...
            links: [
                "confusable": [
                    KGCardLinkSummary(id: "l-pp-1", cardId: ids["proceed"]!, word: "proceed", kind: "confusable", label: "易混淆", confidence: 0.85, reason: "precede（先於）vs proceed（繼續）— 字根不同但拼寫相近")
                ]
            ]
        ),
        EntrySpec(
            ...
            links: [
                "confusable": [
                    KGCardLinkSummary(id: "l-pp-2", cardId: ids["precede"]!, word: "precede", kind: "confusable", label: "易混淆", confidence: 0.85, reason: "proceed（繼續）vs precede（先於）— 字根不同但拼寫相近")
                ]
            ]
        ),
    ...
    static let linkSpecs: [LinkSpec] = [
        // affect ↔ effect
        LinkSpec(id: "gl-1", from: ids["affect"]!, to: ids["effect"]!, kind: "confusable", confidence: 0.95, reason: "affect (v.) vs effect (n.)"),
        // complement ↔ compliment
        LinkSpec(id: "gl-2", from: ids["complement"]!, to: ids["compliment"]!, kind: "confusable", confidence: 0.92, reason: "complement vs compliment"),
        // imply ↔ infer
        LinkSpec(id: "gl-3", from: ids["imply"]!, to: ids["infer"]!, kind: "confusable", confidence: 0.90, reason: "imply vs infer"),
        // elicit ↔ illicit
        LinkSpec(id: "gl-4", from: ids["elicit"]!, to: ids["illicit"]!, kind: "confusable", confidence: 0.88, reason: "elicit vs illicit"),
        // precede ↔ proceed
        LinkSpec(id: "gl-5", from: ids["precede"]!, to: ids["proceed"]!, kind: "confusable", confidence: 0.85, reason: "precede vs proceed"),
        ...
        LinkSpec(id: "gl-7", from: ids["ephemeral"]!, to: ids["resilient"]!, kind: "related", confidence: 0.50, reason: "Conceptual contrast: fleeting vs enduring"),
    ]
}
