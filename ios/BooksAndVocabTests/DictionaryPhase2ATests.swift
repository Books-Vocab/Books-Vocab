...
private actor P1MaterializeService: DictionaryServing {
    ...
    func materializeDictionaryLink(
        ...
        materializeCount += 1
        let json = #"{"targetCard":{"id":"target","content":"lucid","meaning":"clear","pos":"adjective","examples":["A lucid answer."],"inflections":[],"notebookId":"nb","cardRole":"dictionary","reviewEligible":false,"readerHidden":false,"promotionState":"idle","promotedAt":null,"isDeleted":false,"isArchived":false,"createdAt":"2026-08-05T00:00:00Z","updatedAt":"2026-08-05T00:00:00Z"},"link":{"id":"\#(linkID)","fromId":"source","toId":"target","kind":"shares_usage","confidence":0.9,"reason":"related"},"createdCard":true,"createdLink":true,"replayed":false}"#
        return try JSONDecoder().decode(
