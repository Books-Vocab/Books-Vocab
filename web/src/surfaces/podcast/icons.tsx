...
export const PlayFillIcon = filledGlyph('<path d="M7 4.8v14.4l11.2-7.2z"/>')
...
export const LockFillIcon = filledGlyph(
...
export const LockCircleFillIcon = filledGlyph(
...
export const PersonCropCircleIcon = glyph(
