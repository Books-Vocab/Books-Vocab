...
export const ChevronLeftIcon = makeGlyph('<path d="M14.5 5.5 8 12l6.5 6.5"/>')

/** SF `chevron.up` — expanded header 收起標題列。 */
export const ChevronUpIcon = makeGlyph('<path d="M5.5 14.5 12 8l6.5 6.5"/>')
...
export const TextformatSizeIcon = makeGlyph(
...
export const SpeakerWaveIcon = makeGlyph(
...
export const TextBubbleIcon = makeGlyph(
...
export const TranslateIcon = makeGlyph(
...
export const TextBookClosedIcon = makeGlyph(
...
export const ListBulletRectIcon = makeGlyph(
...
export const CheckmarkIcon = makeGlyph('<path d="M4.5 12.5 9.5 18 19.5 6.5"/>')

/** SF `text.line.spacing` — 行距 chip。 */
export const LineSpacingIcon = makeGlyph(
...
export const BookPagesIcon = makeGlyph(
...
export const SunIcon = makeGlyph(
...
export const BookOpenIcon = makeGlyph(
...
export const MoonStarsIcon = makeGlyph(
...
export const GlobeIcon = makeGlyph(
