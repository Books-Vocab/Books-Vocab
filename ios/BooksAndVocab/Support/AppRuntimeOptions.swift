...
enum AppRuntimeOptions {
    ...
    static func shouldGateDictionaryLoading(arguments: [String] = ProcessInfo.processInfo.arguments) -> Bool {
        isUITesting(arguments: arguments) && arguments.contains("-dictionaryLoadingGate")
    }
