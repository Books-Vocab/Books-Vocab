...
const BATCH = [
  { surface: 'Settings · Sections · Preferences', dir: 'settings-preferences', scenarios: ['含自動同步', '未登入 / 無同步列', '自動同步關閉'] },
  { surface: 'Settings · Sections · Review', dir: 'settings-review', scenarios: ['密集模式', '寬鬆模式', '已凍結進度', '自訂模式 / 展開參數'] },
  { surface: 'Settings Subscription Section', dir: 'settings-subscription', scenarios: ['Inactive · Free', 'Loading', 'Pricing Unavailable', 'Pro Active'] },
]
