...
export const SealCheckFillIcon = filledGlyph(
  '<path d="M12 2.2l2 1.7 2.6-.4 1 2.4 2.4 1-.4 2.6 1.7 2-1.7 2 .4 2.6-2.4 1-1 2.4-2.6-.4-2 1.7-2-1.7-2.6.4-1-2.4-2.4-1 .4-2.6-1.7-2 1.7-2-.4-2.6 2.4-1 1-2.4 2.6.4zm-1.4 12.9l-2.8-2.8 1.2-1.2 1.6 1.6 4.4-4.4 1.2 1.2z"/>',
)
...
/** 疊書 hero 插圖 — 登入卡頂部 app icon 的簡化線稿（64×64 用）。 */
export const BooksHeroIcon = glyph(
  '<rect x="4.5" y="14.5" width="14" height="3.4" rx="1"/>' +
    '<rect x="5.5" y="11.1" width="13" height="3.4" rx="1"/>' +
    '<rect x="6.5" y="7.7" width="12" height="3.4" rx="1"/>' +
    '<circle cx="17.5" cy="6.6" r="2.6" fill="currentColor" stroke="none" opacity="0.55"/>' +
    '<path d="M8.5 9.4h6M7.5 12.8h6M6.5 16.2h6"/>',
)
