...
def test_two_concurrent_stages_cannot_lose_each_others_row(tmp_path):
    ...
    shutil.copy2(
        BACKLOG_PATH.parent / "backlog_contract.py", repo / "ops" / "backlog_contract.py"
    )
    shutil.copy2(
        BACKLOG_PATH.parent / "backlog_view.py", repo / "ops" / "backlog_view.py"
    )
    shutil.copy2(
        BACKLOG_PATH.parent / "backlog_legacy.py", repo / "ops" / "backlog_legacy.py"
    )
    shutil.copy2(
        BACKLOG_PATH.parent / "backlog_query.py", repo / "ops" / "backlog_query.py"
    )
    shutil.copy2(
    ...
    shutil.copy2(
        BACKLOG_PATH.parent / "backlog_verification.py", repo / "ops" / "backlog_verification.py"
    )
    shutil.copy2(
        BACKLOG_PATH.parent / "backlog_reanchor.py", repo / "ops" / "backlog_reanchor.py"
    )
    shutil.copy2(
