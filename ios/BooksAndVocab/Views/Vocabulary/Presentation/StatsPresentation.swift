...
/// Single source of time for the Overview/Stats projection and its calendar
/// consumers. The live app supplies this from ReviewSettingsStore; fixtures
/// and tests must provide an explicit anchor.
struct StatsProjectionClock: Equatable {
    let now: Date
