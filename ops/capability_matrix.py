...
SURFACES = [
    ...
    Surface("ios.ops.catalog", "./ops/ios_ops.sh", "./ops/ios_ops.sh catalog snapshots --dataset <name> --json", "operator", "local-artifact", "local", "local screenshot artifact generation from an explicit UI World"),
