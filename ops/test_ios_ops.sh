...
jq -nc --arg log "$runs_tmp/build.log" --arg xcresult "$runs_tmp/Build.xcresult" \
  '{schema:"kg.ios.run-verdict.v1",kind:"build",status:"ok",result:"ok",exit:"0",reason:null,caller:"fixture with spaces",elapsed:"3s",executed:null,timings:{bootMs:120,xcodebuildMs:3000,totalMs:3120,probeMs:777},artifacts:{log:$log,xcresult:$xcresult}}' \
